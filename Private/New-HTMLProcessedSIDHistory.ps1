    ...
    New-HTML {
        ...
        New-HTMLTab -Name 'Current Deletion Status' {
            ...
            New-HTMLTable -DataTable $Export.CurrentRun -Filtering {
                New-HTMLTableCondition -Name 'Enabled' -ComparisonType bool -Operator eq -Value $true -BackgroundColor MintGreen -FailBackgroundColor Salmon
                New-HTMLTableCondition -Name 'SIDBeforeTargetedCount' -ComparisonType number -Operator gt -Value 0 -BackgroundColor LightCoral -FailBackgroundColor LightGreen
                New-HTMLTableCondition -Name 'SIDAfterTargetedCount' -ComparisonType number -Operator eq -Value 0 -BackgroundColor LightGreen -FailBackgroundColor Salmon
